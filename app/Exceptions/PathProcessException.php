...
class PathProcessException extends RuntimeException
{
    ...
    {
        return new self(
            message: 'Path service process failed to execute.',
    ...
    {
        return new self(
            message: 'Path service process returned invalid JSON output.',
